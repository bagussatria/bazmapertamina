		...
		<div class="container">
			<div class="row py-5 my-4">
				...
				<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
					...
					<div id="tweet" class="twitter" data-plugin-tweets data-plugin-options="{'username': 'bagussatriaid', 'count': 2}">
						<p>Please wait...</p>
					</div>
				</div>
				...
				<div class="row py-4">
					<div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
						<a href="index.html" class="logo pr-0 pr-lg-3">
							<img alt="Baituzzakah Pertamina" src="img/logo.png" class="opacity-5" height="33">
						</a>
					</div>
